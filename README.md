...
## 📂 Repository Contents
* `index.html` — Core web documentation and logic structure.

## 🔌 Hardware & Circuits
Since this repository serves strictly as a lightweight code archive, all comprehensive **circuit wiring**, **Code**, and **components name** are hosted dynamically on the web platform linked above.
